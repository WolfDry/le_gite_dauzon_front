...
const EventCard = ({ event }: Props) => {
  return (
    <Container.Column width="27vw" mWidth="21.875rem" height="35rem" mHeight="40rem" alignItems="flex-start" borderRadius="1.25rem" background={white} boxShadow="4px 4px 20px 0 rgba(23, 28, 25, 0.10)">
