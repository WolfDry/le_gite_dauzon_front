...
const MasonryStyled = styled.div<CssProps>`
  display: ${(props) => props.display ?? 'initial'};
  column-count: ${(props) => props.columnCount ?? "3"};
  ...
  @media (max-width: 1050px) {
    column-count: ${(props) => props.mColumnCount ?? "1"};
    column-gap: ${(props) => props.mColumnGap ?? "1rem"};
