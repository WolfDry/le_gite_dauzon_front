...
import { Column } from '../../components/atoms/Container'
import { Action, Container } from '../../components/atoms'

const meta: Meta<typeof Column> = {
  title: 'Components/Container/Column',
  component: Column,
  args: {
    children: (
      <>
        ...
        <Column padding="1rem" background="#ddd">
  ...
  argTypes: {
    ...
    background: { control: 'text', description: 'Propriété du fond' },
