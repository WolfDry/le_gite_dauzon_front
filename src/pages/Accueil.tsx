...
const Accueil = () => {
  ...
  const stays = [
    {
      id: 1,
      title: "Balazuc, village de caractère",
    ...
    {
      id: 2,
      title: "Vogüe, nature et charme médiéval",
    ...
    {
      id: 3,
      title: "Labeaume, village pittoresque",
    ...
    {
      id: 4,
      title: "Vallon et son arche majestueuse",
    ...
    {
      id: 5,
      title: "Banne, au pied des Cévennes",
